...
1. _Good test coverage_. Because we're all professionals here. Specs are written with [Jasmine](https://jasmine.github.io/) and [Jasmine-jQuery](https://github.com/velesin/jasmine-jquery).
